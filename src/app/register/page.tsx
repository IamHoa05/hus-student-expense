...
export default function RegisterPage() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    alert("Đăng ký thành công! Đang chuyển hướng vào ứng dụng...");
  ...
  return (
    <main className="flex flex-col w-full max-w-md mx-auto min-h-screen bg-[#f9f9fe] px-6 relative overflow-hidden">
      ...
      <div className="pt-6 z-20">
        <button
          onClick={() => router.back()}
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#f3f3f8] text-[#4b5b9a] hover:bg-[#e2e2e7] transition-colors active:scale-95 -ml-2"
        >
          <span className="material-symbols-outlined">arrow_back</span>
        </button>
      </div>

      <div className="flex-1 flex flex-col justify-center pb-12 pt-6 z-10">
        {/* Heading */}
        <div className="mb-8">
          <h1 className="font-headline text-3xl font-extrabold text-[#1a1c1f] tracking-tight">
            Tạo tài khoản mới
          </h1>
          <p className="text-[#616470] mt-2 text-sm leading-relaxed">
            Bắt đầu quản lý chi tiêu và chinh phục các mục tiêu tài chính của
            bạn ngay hôm nay.
          </p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#f3f3f8] border border-[#e2e2e7] rounded-2xl py-3.5 pl-12 pr-4 text-[#1a1c1f] focus:ring-2 focus:ring-[#4b5b9a]/30 focus:border-[#4b5b9a] transition-all font-medium placeholder:text-[#c6c5d1]"
              />
            </div>
          </div>
        ...
        {/* Footer Link */}
        <p className="text-center mt-8 text-sm text-[#616470] font-medium">
          Đã có tài khoản?{" "}
          <Link
            href="/login"
